...
> **Playbook:** poteto-mode orchestrate + multi-phase plan. Waves 2–4 in PR #26. Wave 1 merged in #25. Packaged as **2.0.0**. Desktop shell deferred to Version 3 shipped separately as **3.0.0** ([shell spec](../../specs/2026-08-22-v3-desktop-shell-design.md)).
